...
class S2VAdaptor(nn.Layer):
    ...
    def __init__(self, in_channels=512):
        ...
        self.channel_inter = nn.Linear(self.in_channels, self.in_channels, bias_attr=False)
...
class RFAdaptor(nn.Layer):
    ...
    def forward(self, x):
        ...
        if visual_feature is not None:
            ...
            visual_feature = visual_feature.reshape([batch, source_channels, 1, v_source_height * v_source_width])
        ...
        if v_rcg_feature is not None:
            ...
            v_rcg_feature = v_rcg_feature.reshape([batch, source_channels, 1, source_height * source_width])
